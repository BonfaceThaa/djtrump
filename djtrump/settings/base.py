"""
Django settings for djtrump project.
...
SECRET_KEY = ')(3ezz(ltti0s-xw^py#i5om-9zw*4wxrp(1e4=ibn!v9fao9)'
...
ROOT_URLCONF = 'djtrump.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, 'djtrump/templates'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
            ...
            'builtins': [
                'djtrump.templatetags.random_donald_image',
            ],
        },
    },
]
